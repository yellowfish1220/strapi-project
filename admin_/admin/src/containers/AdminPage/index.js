...
export class EditPage extends React.Component {
  ...
  render() {
    ...
    const {
      ctmAdminLayout: { contentTypesToHide, contentTypesToReadOnly },
    } = this.context;

    if (
      contentTypesToReadOnly.indexOf(this.getModelName()) !== -1 ||
      contentTypesToHide.indexOf(this.getModelName()) !== -1
    ) {
      ...
      return <BlockerComponent {...blockerComponentProps} />;
    }
